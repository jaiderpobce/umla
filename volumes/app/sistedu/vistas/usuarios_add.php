            ...
            <div class="container-fluid">
                <div class="widget-list row">
                    ...
                    <div class="col-md-12 widget-holder">
                        ...
                        <?php } ?>
                        <form method="post" action="usuarios_add1.php" id="formU">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="text-muted">Seleccione los roles del usuario</p>  
                                                <div class="checkbox checkbox-rounded checkbox-primary">
                                                    <label>
                                                        <input type="checkbox" name="admin" value="1"> <span class="label-text">Admin</span>
                                                    </label>
                                                </div>
                                                <!-- /.checkbox -->
                                                <div class="checkbox checkbox-rounded checkbox-primary">
                                                    <label>
                                                        <input type="checkbox" name="entrenador" value="1"> <span class="label-text">Entrenador</span>
                                                    </label>
                                                </div>
                                                <!-- /.checkbox -->
                                                <div class="checkbox checkbox-rounded checkbox-primary">
                                                    <label>
                                                        <input type="checkbox" name="tesorero" value="1"> <span class="label-text">Tesorero</span>
                                                    </label>
                                                </div>
                                                <!-- /.checkbox -->
                                                ...
                                                <div class="checkbox checkbox-rounded checkbox-primary">
                                                    <label>
                                                        <input type="checkbox" name="sysadmin" value="1"> <span class="label-text">Sysadmin</span>
                                                    </label>
                                                </div>
                                              <?php } ?>
                                                <!-- /.checkbox -->
                                                <div class="checkbox checkbox-rounded checkbox-primary">
                                                    <label>
                                                        <input type="checkbox" name="apoderado" id="apoderado" value="1"> <span class="label-text">Apoderado</span>
                                                    </label>
                                                </div>
                                            </div>
                                        <div class="form-group oculto" id="nadadores">
