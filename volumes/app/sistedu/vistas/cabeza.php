        ...
        <nav class="navbar" style="background-color: #DFB169;">
                ...
                <div class="navbar-header" >
                    <a href="intro.php" class="navbar-brand" >
                        ...
                        if($imagen_clubv==''){
                            //echo 'sin logo';
                            ?>
                                <img class="logo-expand"  alt=""  src="<?php echo BASE_PATH_CONTROL; ?>assets/img/Logo-martin.png?v=3.3">
                        <?php  }else{
                              //echo 'con logo';
                          ?>
                            <img class="logo-expand" style="height:80px;padding:5px" alt="" src="<?php echo BASE_PATH_CONTROL; ?>uploads/<?php echo $imagen_club; ?>?v=3.3">
                        <?php  }  ?>

                        <img class="logo-collapse" alt="" src="<?php echo BASE_PATH_CONTROL; ?>assets/img/favicon_martin.png?v=3.4">
                    </a>
                </div>
                <!-- /.navbar-header -->
                        ...
                        class="dropdown-menu dropdown-left dropdown-card dropdown-card-profile animated flipInY">
                            <div class="card">
                                ...
                                <ul class="list-unstyled card-body">
                                    ...
                                    <li><a href=""><span><span class="align-middle">Datos personales</span></span></a>
                                    </li>
