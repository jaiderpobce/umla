                                            ...
                                            fclose($file);*/
                                                  ...
                                                  $CZip->agregar($datosN);
                                                   ...
                                                   /* $info = implode ( ";" , $Tpiscina );
                                                    ...
                                                    $prueba_arr = Prueba::getByValoresMeet($datos_comp[9], $datos_comp[8], $datos_comp[4]);
                                                    ...
                                                    $valor_control1 = $mm_50;

                                                  
                                                    if (!empty($mm_50)) {
                                                        $mm_50 = str_replace(",", ".", $mm_50);                                                       
                                                        $valor_control2 = $mm_50;
                                                        $posicion_coincidencia = strpos($mm_50, ":");
                                                        if ($posicion_coincidencia === false) {
                                                            $mm_50 = "00:".$mm_50;
                                                        }
                                                        
                                                        $valor_control3 = $mm_50;
                                                    }
                                                    if (!empty($mm_25)) {
                                                        $mm_25 = str_replace(",", ".", $mm_25); 
                                                        $posicion_coincidencia25 = strpos($mm_25, ":");
                                                        if ($posicion_coincidencia25 === false) {
                                                            $mm_25 = "00:".$mm_25;
                                                        }                                                      
                                                    ...
                                                    if (!empty($mm_y)) {
                                                        ...
                                                        $posicion_coincidenciay = strpos($mm_y, ":");
                                                        if ($posicion_coincidenciay === false) {
                                                            $mm_y = "00:".$mm_y;
                                                        }                                                       
                                                    ...
                                                    */
                                                    ...
                                                    $contenidoff = $contenidoff.$id_comp.", ".$datos_comp[0].", ".$prueba.", ".$tipo_pru.", ".$categoria.", ".$genero.", ".$jornadaP.", ".$marca_min.", ".$mm.", ".$maxn.", ".$edades.", ".$Tpiscina." , ".$valor_control1." , ".$valor_control2." , ".$valor_control3." , ".$valor_control4."\n";
                                                    ...
                                                    $CZip->agregarPrueba($id_comp, $datos_comp[0], $prueba, $tipo_pru, $categoria, $genero, $jornadaP, $marca_min, $mm, $maxn, $edades, $Tpiscina, $relevo);
                                                }
