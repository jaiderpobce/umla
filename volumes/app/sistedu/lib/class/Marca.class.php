...
class Marca
{
	...
	public function agregar ($nadador,$competencia,$prueba,$prueba_id,$fecha,$tiempo,$piscina,$lugar=0,$final=0,$totnadpru=0,$id_origen=0, $exh=0, $puntos=0, $ns=0,  $dq=0)  {
	...
	public function getAll ($nadador)
	{
				...
				$sql = "SELECT ".$this->tabla.".*, com_pruebas.id AS prueba, com_pruebas.nombre AS nombre_pru, com_competencias.nombre FROM ".$this->tabla
                                        ...
                                        . "WHERE ".$this->tabla.".nadador=:id AND ".$this->tabla.".dq=0 AND ".$this->tabla.".tiempo > 0  ORDER BY com_pruebas.orden, ".$this->tabla.".fecha DESC, ".$this->tabla.".final";
    				$bind = array(
        			':id' => $nadador
    				);
